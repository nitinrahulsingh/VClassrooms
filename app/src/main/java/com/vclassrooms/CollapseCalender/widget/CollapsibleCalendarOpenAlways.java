package com.vclassrooms.CollapseCalender.widget;
...
import com.vclassrooms.CollapseCalender.data.CalendarAdapter;
import com.vclassrooms.CollapseCalender.data.Day;
import com.vclassrooms.CollapseCalender.data.Event;
import com.vclassrooms.CollapseCalender.view.ExpandIconView;
import com.vclassrooms.R;

import java.text.SimpleDateFormat;
import java.util.Calendar;

public class CollapsibleCalendarOpenAlways extends UICalendar {
    ...
    public CollapsibleCalendarOpenAlways(Context context) {
        super(context);
    }

    public CollapsibleCalendarOpenAlways(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CollapsibleCalendarOpenAlways(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(Context context) {
        ...
        // bind events
        mBtnPrevMonth.setVisibility(GONE);
        mBtnNextMonth.setVisibility(GONE);
        mBtnPrevWeek.setVisibility(GONE);
        mBtnNextWeek.setVisibility(GONE);
    ...
    public void collapse(int duration) {
        ...
        if (getState() == STATE_EXPANDED) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mLayoutBtnGroupWeek.setBackgroundTintList(getResources().getColorStateList(R.color.light_blue));
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mLayoutBtnGroupMonth.setBackgroundTintList(getResources().getColorStateList(R.color.light_blue));
            }
