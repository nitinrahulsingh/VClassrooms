package com.vclassrooms.photopicker.adapter;
...
//        Glide.with(context).load(item.getPathFile()).asBitmap().placeholder(R.drawable.piclist_icon_default).into(holder.imageItem);  rahul

        Glide.with(context)
                .load(item.getPathFile())
                .into(holder.imageItem);
        // Picasso.with(this.context).load(latest File(item.getPathFile())).placeholder(R.drawable.piclist_icon_default).into(holder.imageItem);
