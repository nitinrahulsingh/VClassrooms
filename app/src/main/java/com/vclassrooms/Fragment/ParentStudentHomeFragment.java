 ...
 */
public class ParentStudentHomeFragment extends Fragment {
    View mview;
    AppUtils appUtils;
    ...
    private void setAllOption() {
         if(strUserTypeID.contentEquals("2")){
            //Student
        ...
        }else  if(strUserTypeID.contentEquals("1")){
            //Parent
            lineartab.setVisibility(View.GONE);
            linearfour.setVisibility(View.VISIBLE);
    ...
    @OnClick({R.id.cardView1,R.id.cardView2,R.id.cardView3})
